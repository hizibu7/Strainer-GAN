...
# 전체 데이터셋의 10%를 2로, 90%를 8로 구성
total_samples = len(two_indices) + len(eight_indices)
num_two_samples = int(total_samples * 0.1)
num_eight_samples = total_samples - num_two_samples
...
# 두 데이터셋 결합
combined_dataset = ConcatDataset([two_dataset, eight_dataset])

# 데이터 개수 확인 및 배치 크기 조정
num_samples = len(combined_dataset)
print(f"Number of samples - 2: {num_two_samples}, 8: {num_eight_samples}, Total: {num_samples}")
